...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 31 17:18:50 2025
...
# Load the dataset
df = pd.read_csv("synthetic_data_kde_univariate.csv", parse_dates=["DateTime"])
print(df.shape)
...
results_df.to_csv("prediction_results_comparison_synthetic.csv", index=False)
