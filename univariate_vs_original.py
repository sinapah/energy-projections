...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr  2 15:57:17 2025
...
synthetic_data = pd.read_csv("synthetic_data_kde_univariate.csv", parse_dates=["DateTime"])
...
plt.title("t-SNE Visualization of Original vs. Univariate KDE-based Synthetic Data")
plt.legend()
plt.show()
