...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr  3 09:12:38 2025
...
X = df.drop(columns=["Ontario Demand", "Market Demand"])  # Features
...
results_df.to_csv("prediction_results_comparison_synthetic_gan.csv", index=False)'''